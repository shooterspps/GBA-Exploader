...
class Font {
	...
	bool parseData(const u8* data, size_t size);
...
public:
	...
	void printString(u16* screen, int x, int y, const char* str, u16 fg, u16 bg);
	...
	void drawTileSub(u16* screen, int x, int y, const char* str, u16 fg, u16 bg);
};
